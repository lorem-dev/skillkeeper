...
export const de: Partial<Catalog> = {
  ...
  'menu.pasteAndMatchStyle': 'Einsetzen und Stil anpassen',
  'menu.delete': 'Löschen',
  ...
  'menu.hide': 'SkillKeeper ausblenden',
  ...
  'common.goToMcp': 'Zu MCP',
  'skills.resetFilters': 'Filter zurücksetzen',
  'skills.componentsTitle': 'Komponenten',
  'skills.managementTitle': 'Verwaltung',
  ...
  'projects.fromReposHint.one': '{count} Fähigkeit aus Repositories installiert',
  'projects.fromReposHint.other': '{count} Fähigkeiten aus Repositories installiert',
  'projects.skillCountHint.one': 'Insgesamt {count} Fähigkeit im Projekt',
  'projects.skillCountHint.other': 'Insgesamt {count} Fähigkeiten im Projekt',
  'projects.agentsHint.one': 'Konfigurationen für {count} Agent vorhanden',
  'projects.agentsHint.other': 'Konfigurationen für {count} Agenten vorhanden',
  'projects.mcpCount': '{count} MCP',
  'projects.mcpHint.one': '{count} MCP-Server aus Repositories installiert',
  'projects.mcpHint.other': '{count} MCP-Server aus Repositories installiert',
