// Public barrel for the generic UI kit. Import components as `@/shared/ui`.
...
export type { FormSectionProps } from './Form';
export { FormRow } from './Form';
export type { FormRowProps } from './Form';
