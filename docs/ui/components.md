...
[`shared/lib/transitions.ts`](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/lib/transitions.ts)
...
Source: [shared/ui/Page/Page.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Page/Page.tsx)
...
Source: [shared/ui/Card/Card.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Card/Card.tsx)

### Divider
`<Divider />` -- a hairline separator.
Source: [shared/ui/Divider/Divider.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Divider/Divider.tsx)
...
Source: [shared/ui/GlassSurface/GlassSurface.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/GlassSurface/GlassSurface.tsx)

### Toolbar
`<Toolbar title leading trailing />` -- a glass bar with leading controls, a title,
and trailing actions (design-system.md 8.7).
Source: [shared/ui/Toolbar/Toolbar.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Toolbar/Toolbar.tsx)
...
Source: [shared/ui/Sidebar](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Sidebar/Sidebar.tsx)
...
accessible name.
Source: [shared/ui/Icon/Icon.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Icon/Icon.tsx)
...
Source: [shared/ui/List](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/List/ListRow.tsx)
...
Source: [shared/ui/Form](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Form/FormRow.tsx)
...
Source: [shared/ui/DisclosureGroup/DisclosureGroup.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/DisclosureGroup/DisclosureGroup.tsx)
...
multiple lines.
Source: [shared/ui/Row/Row.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Row/Row.tsx)
...
8.12.
Source: [shared/ui/Table/Table.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Table/Table.tsx)
...
Source: [shared/ui/TreeView/TreeView.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/TreeView/TreeView.tsx)
...
Source: [shared/ui/Toggle/Toggle.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Toggle/Toggle.tsx)

### RadioGroup
`<RadioGroup name value options onChange label? />` -- controlled single choice;
`options: { value, label, disabled? }[]`.
Source: [shared/ui/RadioGroup/RadioGroup.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/RadioGroup/RadioGroup.tsx)
...
Source: [shared/ui/SegmentedControl/SegmentedControl.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/SegmentedControl/SegmentedControl.tsx)
...
Source: [shared/ui/TextField/TextField.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/TextField/TextField.tsx)

### Select
`<Select label? options? />` -- styled native select with a custom chevron; pass
`options: { value, label, disabled? }[]` or `<option>` children.
Source: [shared/ui/Select/Select.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Select/Select.tsx)
...
Source: [shared/ui/SearchField/SearchField.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/SearchField/SearchField.tsx)

### Slider
`<Slider />` -- styled native range input; forwards native input attributes
(`min`, `max`, `step`, `value`, `onChange`). Design-system.md 8.3.
Source: [shared/ui/Slider/Slider.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Slider/Slider.tsx)
...
Source: [shared/ui/Stepper/Stepper.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Stepper/Stepper.tsx)
...
Source: [shared/ui/IntervalStepper/IntervalStepper.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/IntervalStepper/IntervalStepper.tsx)
...
Source: [shared/ui/Combobox/Combobox.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Combobox/Combobox.tsx)
...
Source: [shared/ui/MultiCombobox/MultiCombobox.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/MultiCombobox/MultiCombobox.tsx)
...
Design-system.md 8.11.
Source: [shared/ui/MultiSelect/MultiSelect.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/MultiSelect/MultiSelect.tsx)
...
Source: [shared/ui/SplitButton/SplitButton.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/SplitButton/SplitButton.tsx)
...
| `warning` | `danger`.
Source: [shared/ui/Badge/Badge.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Badge/Badge.tsx)

### Spinner
`<Spinner label? />` -- indeterminate activity ring with a status label.
Design-system.md 8.10.
Source: [shared/ui/Spinner/Spinner.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Spinner/Spinner.tsx)

### ProgressBar
`<ProgressBar value? label? />` -- determinate when `value` (0..1) is given,
indeterminate when omitted. Design-system.md 8.10.
Source: [shared/ui/ProgressBar/ProgressBar.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/ProgressBar/ProgressBar.tsx)

### Skeleton
`<Skeleton width? height? radius? />` -- shimmering loading placeholder
(decorative; hidden from assistive tech).
Source: [shared/ui/Skeleton/Skeleton.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Skeleton/Skeleton.tsx)

### Tooltip
`<Tooltip content>trigger</Tooltip>` -- shows a label on hover/focus; animated
in/out. Sets `role="tooltip"` and wires `aria-describedby`.
Source: [shared/ui/Tooltip/Tooltip.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Tooltip/Tooltip.tsx)
...
Source: [shared/ui/Alert/Alert.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Alert/Alert.tsx)
...
Source: [shared/ui/Modal/Modal.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/Modal/Modal.tsx)
...
Source: [shared/ui/SearchSummary/SearchSummary.tsx](https://github.com/lorem-dev/skillkeeper/blob/main/apps/desktop/src/renderer/shared/ui/SearchSummary/SearchSummary.tsx)
